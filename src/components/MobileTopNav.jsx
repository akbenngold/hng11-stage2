...
function MobileTopNav() {
  ...
  return (
    <div
      className={`navbar w-full absolute top-0 lg:hidden transition-all duration-500 z-50`}
    >
      <div className="flex-1 gap-2">
        <NavLink to="/">
          ...
          >
            <path
              d="M6.66699 22.6666H25.3337M6.66699 16H25.3337M6.66699 9.33331H25.3337"
              stroke="black"
              stroke-width="2"
        ...
        <a className="mx-[-1rem] btn btn-ghost text-xl fredoka flex items-center">
          <img className="h-6" src={logo} alt="logo" /> TimbuCloudShop
        </a>
      </div>
